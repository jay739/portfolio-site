        ...
        >
          ...
          >
            ...
            <button
              ...
              className="absolute top-1 right-1 z-10 p-1 rounded-full neural-control-btn-ghost hover:border-red-400/70 hover:text-red-200"
            ...
            <div className="relative neural-card-soft backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-slate-600/55">
