  ...
  return (
    <div className="flex flex-col gap-2">
      {/* Main control button removed from above, now always in the media player row */}
        <div className="flex items-center gap-2 p-2 neural-card-soft rounded-lg border border-violet-400/20">
          <button
            onClick={skipBackward}
            className="neural-control-btn px-2 py-1"
        ...
        <button
          ...
          className="neural-control-btn-primary inline-flex items-center gap-1 px-3 py-1 disabled:opacity-50 disabled:cursor-not-allowed"
