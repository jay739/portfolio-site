...
function validateContactForm(data: {
  ...
  if (!data.message.trim() || data.message.trim().length < 20) {
    errors.message =
      "Please share a little more context so I can respond helpfully.";
  }
...
export default function ContactSection() {
    ...
    try {
      ...
      if (res.ok && responseData.success) {
        ...
        const successMessage =
          responseData.message || "Message sent! I will get back to you soon.";
  ...
  const resumeHighlights = [
    {
      label: "Private AI cloud + homelab platform",
      href: "/projects?project=ai-platform-infrastructure-batcave-personal-ml-cloud",
    },
  ...
  return (
    <section
      className="relative pt-0 pb-16 px-2 sm:px-6 w-full overflow-hidden"
      id="contact"
    >
      <div className="w-full relative">
        ...
        >
          ...
          <motion.p
            className="neural-section-copy text-center mb-8"
            variants={itemVariants}
          >
          ...
          >
            ...
            <div className="rounded-xl border border-slate-700/55 bg-slate-900/50 p-3">
              ...
              <p
                className={`mt-1 text-sm font-medium ${isReadyToSend ? "text-emerald-300" : "text-amber-200"}`}
              >
              ...
              <div className="mt-3 space-y-2">
                {resumeHighlights.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
                    className="block text-sm text-amber-200 transition hover:text-amber-100"
                  >
                    {item.label} →
                  </a>
                ))}
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-400">
                  {lastSavedAt
                    ...
                    : "We keep your in-progress message locally on this device."}
                </p>
              </div>
              <button
                type="button"
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              <motion.div variants={itemVariants}>
                <label
                  htmlFor="name"
                  className="block text-base sm:text-lg font-medium text-slate-100 mb-2"
                >
                  Name *
                </label>
                <input
            ...
            <motion.div variants={itemVariants}>
              ...
              {!fieldErrors.subject &&
                subjectDraft.trim().length > 0 &&
                subjectDraft.trim().length < 3 && (
                  <p className="mt-2 text-xs text-amber-300">
                    A slightly more specific subject helps route your message
                    faster.
                  </p>
                )}
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              {!fieldErrors.message &&
                messageDraft.trim().length > 0 &&
                messageDraft.trim().length < 20 && (
                  <p className="mt-2 text-xs text-amber-300">
                    A few more details will make the reply much more useful.
                  </p>
                )}
              {fieldErrors.message && (
                <motion.p
            ...
            {status === "success" && (
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap gap-2 text-xs text-slate-300">
                  <span className="neural-pill-intro">
                    Next step: watch your inbox
                  </span>
                  <span className="neural-pill-intro">
                    Include links or docs in your reply if needed
                  </span>
                </div>
              </motion.div>
            )}
