...
export const volunteerExperience = {
  title: "Technical and Design Head at Emerging Computers Arena (ECA SNIST)",
  details: [
    "Designed college fest website and posters using Adobe Illustrator, Bootstrap, and HTML.",
    "Public Speaker in the Tech Series: Spoke about the Emergence of Data Storage technologies."
  ]
}; 