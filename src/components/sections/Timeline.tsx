        ...
        <div className="relative w-full neural-card neural-glow-border p-4 sm:p-8">
          <div className="mb-8">
            ...
            <h2 className="neural-section-title mt-2 flex items-center gap-2">
              <FaClock className="text-amber-400" /> Timeline
            </h2>
            <p className="neural-section-copy mt-2 max-w-3xl">
              My timeline of roles, milestones, and measurable outcomes across
              AI/ML, systems, and product delivery.
            </p>
          </div>
