...
const techIconMap: Record<
  string,
  { icon: React.JSX.Element; url: string; label: string }
> = {
  Python: {
    icon: <DynamicIcon name="python" />,
    url: "https://www.python.org/",
    label: "Python",
  },
  JavaScript: {
    icon: <DynamicIcon name="javascript" />,
    url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript",
    label: "JavaScript",
  },
  TypeScript: {
    icon: <DynamicIcon name="typescript" />,
    url: "https://www.typescriptlang.org/",
    label: "TypeScript",
  },
  React: {
    icon: <DynamicIcon name="react" />,
    url: "https://react.dev/",
    label: "React",
  },
  "Next.js": {
    icon: <DynamicIcon name="next.js" />,
    url: "https://nextjs.org/",
    label: "Next.js",
  },
  Astro: {
    icon: <DynamicIcon name="astro" />,
    url: "https://astro.build/",
    label: "Astro",
  },
  "Node.js": {
    icon: <DynamicIcon name="node.js" />,
    url: "https://nodejs.org/",
    label: "Node.js",
  },
  Docker: {
    icon: <DynamicIcon name="docker" />,
    url: "https://www.docker.com/",
    label: "Docker",
  },
  Kubernetes: {
    icon: <DynamicIcon name="kubernetes" />,
  ...
  "CI/CD": {
    icon: <DynamicIcon name="ci/cd" />,
    url: "https://en.wikipedia.org/wiki/CI/CD",
    label: "CI/CD",
  },
  Portainer: {
    icon: <DynamicIcon name="portainer" />,
    url: "https://www.portainer.io/",
    label: "Portainer",
  },
  Nginx: {
    icon: <DynamicIcon name="nginx" />,
    url: "https://nginx.org",
    label: "Nginx",
  },
  "Uptime Kuma": {
    icon: <DynamicIcon name="uptime kuma" />,
    url: "https://github.com/louislam/uptime-kuma",
    label: "Uptime Kuma",
  },
  TensorFlow: {
    icon: <DynamicIcon name="tensorflow" />,
    url: "https://www.tensorflow.org/",
    label: "TensorFlow",
  },
  PyTorch: {
    icon: <DynamicIcon name="pytorch" />,
    url: "https://pytorch.org/",
    label: "PyTorch",
  },
  NLP: {
    icon: <DynamicIcon name="nlp" />,
    url: "https://en.wikipedia.org/wiki/Natural_language_processing",
    label: "NLP",
  },
  "Computer Vision": {
    icon: <DynamicIcon name="computer vision" />,
    url: "https://en.wikipedia.org/wiki/Computer_vision",
    label: "Computer Vision",
  },
  MLOps: {
    icon: <DynamicIcon name="mlops" />,
    url: "https://en.wikipedia.org/wiki/MLOps",
    label: "MLOps",
  },
  Pandas: {
    icon: <DynamicIcon name="pandas" />,
    url: "https://pandas.pydata.org/",
    label: "Pandas",
  },
  "Scikit-learn": {
    icon: <DynamicIcon name="scikit-learn" />,
    url: "https://scikit-learn.org/",
    label: "Scikit-learn",
  },
  LangChain: {
    icon: <DynamicIcon name="langchain" />,
    url: "https://www.langchain.com/",
    label: "LangChain",
  },
  Ollama: {
    icon: <DynamicIcon name="ollama" />,
    url: "https://ollama.com/",
    label: "Ollama",
  },
  AWS: {
    icon: <DynamicIcon name="aws" />,
    url: "https://aws.amazon.com/",
    label: "AWS",
  },
  GCP: {
    icon: <DynamicIcon name="gcp" />,
    url: "https://cloud.google.com/",
    label: "GCP",
  },
  "GitHub Actions": {
    icon: <DynamicIcon name="github actions" />,
    url: "https://github.com/features/actions",
    label: "GitHub Actions",
  },
  Watchtower: {
    icon: <DynamicIcon name="watchtower" />,
    url: "https://containrrr.dev/watchtower/",
    label: "Watchtower",
  },
  Vaultwarden: {
    icon: <DynamicIcon name="vaultwarden" />,
    url: "https://vaultwarden.dev/",
    label: "Vaultwarden",
  },
  "HTML/CSS": {
    icon: <DynamicIcon name="html/css" />,
    url: "https://developer.mozilla.org/en-US/docs/Web/HTML",
    label: "HTML/CSS",
  },
  "Tailwind CSS": {
    icon: <DynamicIcon name="tailwind css" />,
    url: "https://tailwindcss.com/",
    label: "Tailwind CSS",
  },
  Tkinter: {
    icon: <DynamicIcon name="tkinter" />,
    url: "https://wiki.python.org/moin/TkInter",
    label: "Tkinter",
  },
  Django: {
    icon: <DynamicIcon name="django" />,
    url: "https://www.djangoproject.com/",
    label: "Django",
  },
  FastAPI: {
    icon: <DynamicIcon name="fastapi" />,
    url: "https://fastapi.tiangolo.com/",
    label: "FastAPI",
  },
  "REST APIs": {
    icon: <DynamicIcon name="rest apis" />,
    url: "https://restfulapi.net/",
    label: "REST APIs",
  },
  Express: {
    icon: <DynamicIcon name="express" />,
    url: "https://expressjs.com/",
    label: "Express",
  },
  Java: {
    icon: <DynamicIcon name="java" />,
    url: "https://www.java.com/",
    label: "Java",
  },
  Go: { icon: <DynamicIcon name="go" />, url: "https://go.dev/", label: "Go" },
  Bash: {
    icon: <DynamicIcon name="bash" />,
    url: "https://www.gnu.org/software/bash/",
    label: "Bash",
  },
  SQL: {
    icon: <DynamicIcon name="sql" />,
    url: "https://en.wikipedia.org/wiki/SQL",
    label: "SQL",
  },
  MySQL: {
    icon: <DynamicIcon name="mysql" />,
    url: "https://www.mysql.com/",
    label: "MySQL",
  },
  PostgreSQL: {
    icon: <DynamicIcon name="postgresql" />,
    url: "https://www.postgresql.org/",
    label: "PostgreSQL",
  },
  MongoDB: {
    icon: <DynamicIcon name="mongodb" />,
    url: "https://www.mongodb.com/",
    label: "MongoDB",
  },
  Azure: {
    icon: <DynamicIcon name="azure" />,
    url: "https://azure.microsoft.com",
    label: "Azure",
  },
  "Power BI": {
    icon: <DynamicIcon name="power bi" />,
    url: "https://powerbi.microsoft.com/",
    label: "Power BI",
  },
  Streamlit: {
    icon: <DynamicIcon name="streamlit" />,
    url: "https://streamlit.io/",
    label: "Streamlit",
  },
  XGBoost: {
    icon: <DynamicIcon name="xgboost" />,
    url: "https://xgboost.readthedocs.io",
    label: "XGBoost",
  },
  "Home Assistant": {
    icon: <DynamicIcon name="home assistant" />,
    url: "https://www.home-assistant.io/",
    label: "Home Assistant",
  },
  qBittorrent: {
    icon: <DynamicIcon name="qbittorrent" />,
      ...
      >
        ...
        >
          <div className="sticky top-0 z-10 h-1 w-full bg-slate-950/80">
            <div
              className="h-full bg-gradient-to-r from-amber-400 via-orange-400 to-amber-200"
          ...
          <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.lifecycle.map((stage) => (
                    <span key={stage} className="neural-pill-intro text-xs">
                      {stage}
                    </span>
                  ))}
                </div>
              ...
              <div className="mb-6 rounded-2xl border border-slate-700/60 bg-slate-950/35 p-4">
                ...
                <div className="grid gap-2 md:grid-cols-2">
                  {project.proofPoints.map((point) => (
                    <div
                      key={point}
                      className="rounded-xl border border-slate-700/50 bg-slate-900/45 px-3 py-2 text-sm text-slate-200"
                    >
                      {point}
                    </div>
                  ))}
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      boxShadow: "inset 0 0 40px 10px rgba(2,6,23,0.6)",
                    }}
                  />
                  {/* Maximize button */}
                  <button
                  ...
                  {project.images.length > 1 && (
                    <>
                      <button
                        className="absolute left-3 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/60 hover:bg-black/90 text-white transition-all"
                        onClick={(e) => {
                          e.stopPropagation();
                          prevImage();
                        }}
                      ...
                      <button
                        className="absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/60 hover:bg-black/90 text-white transition-all"
                        onClick={(e) => {
                          e.stopPropagation();
                          nextImage();
                        }}
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {project.tags.map((tag) => (
                <span key={tag} className="neural-pill text-xs sm:text-sm">
                  {tag}
                </span>
              ))}
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                type="button"
                onClick={() => void copyToClipboard(shareUrl, "case-study")}
              ...
              {project.github && (
                <button
                  type="button"
                  onClick={() =>
                    void copyToClipboard(project.github!, "github")
                  }
                  className="neural-control-btn-ghost flex items-center gap-2 px-4 py-2 font-medium shadow"
                >
                  <Copy className="h-4 w-4" />
              ...
              {project.demo && (
                <button
                  type="button"
                  onClick={() => void copyToClipboard(project.demo!, "link")}
                  className="neural-control-btn-ghost flex items-center gap-2 px-4 py-2 font-medium shadow"
                >
                  <Copy className="h-4 w-4" />
                  <span>Copy Demo</span>
              ...
              <button
                type="button"
                onClick={readProjectDescription}
                className="neural-control-btn flex items-center gap-2 px-4 py-2 font-medium shadow"
              >
                {isReading ? (
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {(project.techStack || project.tags)
                    ...
                    .map((entry) => (
                      <a
                        key={entry}
                        href={`/projects?tag=${encodeURIComponent(entry)}`}
              ...
              <div className="rounded-2xl border border-slate-700/60 bg-slate-950/35 p-4">
                <p className="text-xs uppercase tracking-widest text-amber-300">
                  Related by Problem Solved
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {(project.problemAreas || project.challenges || [])
                    .slice(0, 5)
                    .map((entry) => (
                      <span
                        key={entry}
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="mb-4">
          <p
            className={`neural-statement-chip block ${compact ? "line-clamp-2 text-xs" : "line-clamp-3 text-sm"}`}
          >
            {project.description}
          </p>
        </div>
        <div className="mb-4 flex flex-wrap gap-1.5">
          {project.featured && (
            <span className="neural-pill-intro text-[10px]">Production</span>
          )}
          {project.lifecycle?.includes("Maintained") && (
            <span className="neural-pill-intro text-[10px]">Maintained</span>
          )}
          {project.lifecycle?.includes("Building") && (
            <span className="neural-pill-intro text-[10px]">Ongoing</span>
          )}
          {project.tags.includes("Infrastructure") && (
            <span className="neural-pill-intro text-[10px]">Self-Hosted</span>
          )}
        </div>
        ...
        {!compact && project.images && project.images.length > 0 && (
          ...
          >
            <div
              className="relative w-full rounded-xl overflow-hidden bg-slate-950/60 border border-slate-700/40 select-none"
              style={{ height: "180px" }}
            >
              <AnimatePresence>
                <motion.div
              ...
              <div
                className="absolute inset-0 pointer-events-none rounded-xl"
                style={{ boxShadow: "inset 0 0 30px 8px rgba(2,6,23,0.5)" }}
              />
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.tags.map((tag) => {
            ...
            return techInfo ? (
              ...
              <span
                key={tag}
                className="neural-pill neural-pill-static text-xs sm:text-sm"
              >
                {tag}
              </span>
            );
      ...
      <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-700/70">
        <div className="flex items-center gap-2">
          <button
            ...
            aria-label={
              isCompared
                ? `Remove ${project.title} from compare`
...
export default function Projects({
  ...
  const [modalImageIdx, setModalImageIdx] = useState(
    Math.max(0, Number(searchParams.get("image") ?? "0") || 0),
  );
  const [sortMode, setSortMode] = useState<
    "featured" | "latest" | "alphabetical"
  >(
    (searchParams.get("sort") as "featured" | "latest" | "alphabetical") ??
      "featured",
  );
  ...
  useEffect(() => {
    ...
    const match = projects.find(
      (project) => projectSlug(project.title) === projectParam,
    );
    if (match) {
  ...
  const filteredProjects = useMemo(() => {
    ...
    if (spotlightId) {
      filtered = filtered.filter(
        (project) => projectSlug(project.title) === spotlightId,
      );
    }
  ...
  const activeModalIndex = modalProject
    ? orderedProjects.findIndex(
        (project) => project.title === modalProject.title,
      )
    : -1;
  ...
  const handlePrevProject = useCallback(() => {
    ...
    const nextIndex =
      (activeModalIndex - 1 + orderedProjects.length) % orderedProjects.length;
  ...
  const toggleCompare = (project: Project) => {
    ...
    setCompareIds((prev) => {
      ...
      pushSiteFeedback(
        next.length >= 2
          ? "Project compare tray is ready."
          : `Added ${project.title} to compare.`,
        "success",
      );
      return next.slice(-2);
    });
    ...
    <>
      <section className={`relative w-full ${className}`}>
        <div className="relative w-full neural-card neural-glow-border p-4 sm:p-8">
          ...
          >
            Selected builds across AI, full-stack engineering, and self-hosted
            systems.
          </motion.p>
              ...
              <div className="xl:col-span-4 space-y-3">
                <div className="flex flex-wrap items-center gap-2 xl:justify-end">
                  ...
                  {[
                    ...
                    <FilterChip
                      ...
                      onClick={() =>
                        setSortMode(
                          mode.key as "featured" | "latest" | "alphabetical",
                        )
                      }
                ...
                <div className="flex flex-wrap items-center gap-2 xl:justify-end">
                  ...
                  <button
                    ...
                    onClick={() =>
                      setSpotlightId((prev) =>
                        prev ? null : projectSlug(projects[0].title),
                      )
                    }
          ...
          <div className="mb-6 text-sm text-slate-400">
            Showing {filteredProjects.length} of {projects.length} projects in
            this view.
            {selectedTag && (
              <span className="ml-2 text-amber-300">Tag: {selectedTag}</span>
            )}
          </div>
          ...
          {compareProjects.length === 0 && (
            <div className="mb-6 rounded-2xl border border-dashed border-slate-700/60 bg-slate-950/20 p-4 text-sm text-slate-400">
              Compare mode is ready. Pin any two projects to inspect stack,
              scope, and delivery focus side by side.
            </div>
          )}
            ...
            <div className="mb-8 rounded-2xl border border-amber-400/25 bg-amber-500/5 p-4 sm:p-6">
              ...
              {compareProjects.length === 1 && (
                <div className="rounded-xl border border-slate-700/50 bg-slate-900/40 p-4 text-sm text-slate-400">
                  Click{" "}
                  <span className="text-amber-300 font-medium">Compare</span> on
                  another project card to start the comparison.
                </div>
              )}
              ...
              {compareProjects.length === 2 &&
                (() => {
                  ...
                  const stackA = new Set(
                    (a.techStack ?? a.tags).map((t) => t.toLowerCase()),
                  );
                  const stackB = new Set(
                    (b.techStack ?? b.tags).map((t) => t.toLowerCase()),
                  );
                  const rawA = a.techStack ?? a.tags;
                  const rawB = b.techStack ?? b.tags;
                  const shared = rawA.filter((t) =>
                    stackB.has(t.toLowerCase()),
                  );
                  const onlyA = rawA.filter(
                    (t) => !stackB.has(t.toLowerCase()),
                  );
                  const onlyB = rawB.filter(
                    (t) => !stackA.has(t.toLowerCase()),
                  );
                  ...
                  return (
                    <div className="space-y-4">
                      ...
                      {rows.map((row) => (
                        ...
                        >
                          <span className="text-slate-500 text-xs font-medium pt-0.5">
                            {row.label}
                          </span>
                      ...
                      <div className="rounded-xl border border-slate-700/50 bg-slate-900/40 p-4 space-y-3">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {shared.map((t) => (
                                <span
                                  key={t}
                                  className="px-2 py-0.5 rounded-full bg-slate-700/60 text-slate-300 text-[11px]"
                                >
                                  {t}
                                </span>
                              ))}
                        ...
                        <div className="grid sm:grid-cols-2 gap-3">
                          {onlyA.length > 0 && (
                            <div>
                              <p className="text-[11px] text-amber-400/80 mb-1.5">
                                Only in {a.title.split(" ")[0]} ({onlyA.length})
                              </p>
                              <div className="flex flex-wrap gap-1.5">
                                {onlyA.map((t) => (
                                  <span
                                    key={t}
                                    className="px-2 py-0.5 rounded-full bg-amber-500/15 border border-amber-400/25 text-amber-200 text-[11px]"
                                  >
                                    {t}
                                  </span>
                                ))}
                          ...
                          {onlyB.length > 0 && (
                            <div>
                              <p className="text-[11px] text-sky-400/80 mb-1.5">
                                Only in {b.title.split(" ")[0]} ({onlyB.length})
                              </p>
                              <div className="flex flex-wrap gap-1.5">
                                {onlyB.map((t) => (
                                  <span
                                    key={t}
                                    className="px-2 py-0.5 rounded-full bg-sky-500/15 border border-sky-400/25 text-sky-200 text-[11px]"
                                  >
                                    {t}
                                  </span>
                                ))}
