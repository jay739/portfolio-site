  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between neural-page-shell gap-4 sm:gap-5">
      ...
      <RouteNextSteps
        items={[
          {
            href: "/skills?mode=map&domain=AI/ML",
            label: "Map the supporting skills",
            note: "See the domains behind these case studies.",
          },
          {
            href: "/impact",
            label: "See measured outcomes",
            note: "Connect project work to concrete delivery impact.",
          },
          {
            href: "/contact?intent=consulting",
            label: "Request a walkthrough",
            note: "Open a project-specific conversation.",
          },
        ]}
      />
    </main>
