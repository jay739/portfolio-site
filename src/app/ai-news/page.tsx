    ...
    <main className="flex min-h-screen flex-col items-center justify-between neural-page-shell gap-4 sm:gap-5">
      <RecentViewTracker
        item={{
          ...
          href: "/ai-news",
          kind: "page",
          description: "Curated AI launches, research, and tooling updates",
        }}
      />
      <NeuralPageIntro
        title="AI News Feed"
        ...
        theme="ai-news"
      />
      <section id="ai-news" className="relative w-full">
      ...
      <RouteNextSteps
        items={[
          {
            href: "/blog",
            label: "Read deeper analysis",
            note: "Move from live headlines into longer-form thinking.",
          },
          {
            href: "/projects?tag=AI/ML",
            label: "See related builds",
            note: "Connect current AI signals to shipped portfolio work.",
          },
          {
            href: "/ai-tools",
            label: "Open the lab",
            note: "Jump from news and trends into hands-on tooling.",
          },
        ]}
      />
    </main>
