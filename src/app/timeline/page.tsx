    ...
    <main className="flex min-h-screen flex-col items-center justify-between neural-page-shell gap-4 sm:gap-5">
      <RecentViewTracker
        item={{
          ...
          href: "/timeline",
          kind: "page",
          description: "Chronological milestones and career narrative",
        }}
      />
      <NeuralPageIntro
        title="Experience Timeline"
      ...
      <RouteNextSteps
        items={[
          {
            href: "/impact",
            label: "See the measurable outcomes",
            note: "Jump from chronology into verified delivery metrics.",
          },
          {
            href: "/skills",
            label: "Open the skills map",
            note: "See the technical topology built through the timeline.",
          },
          {
            href: "/projects",
            label: "Browse the shipped work",
            note: "Move from milestones into concrete builds.",
          },
        ]}
      />
    </main>
